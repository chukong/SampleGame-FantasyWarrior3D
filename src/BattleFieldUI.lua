...
function BattlefieldUI:bloodbarInit()
    ...
    self.WarriorBlood:setPosition(self.WarriorPng:getPositionX(), self.WarriorPng:getPositionY()-31)
    ...
    self.WarriorBloodClone:setPosition(self.WarriorPng:getPositionX(), self.WarriorPng:getPositionY()-31)
    ...
    self.ArcherBlood:setPosition(self.ArcherPng:getPositionX(), self.ArcherPng:getPositionY()-31)
    ...
    self.ArcherBloodClone:setPosition(self.ArcherPng:getPositionX(), self.ArcherPng:getPositionY()-31)
    ...
    self.MageBlood:setPosition(self.MagePng:getPositionX(), self.MagePng:getPositionY()-31)
    ...
    self.MageBloodClone:setPosition(self.MagePng:getPositionX(), self.MagePng:getPositionY()-31)
